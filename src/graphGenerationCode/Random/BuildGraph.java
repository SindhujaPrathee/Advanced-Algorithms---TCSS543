...
public class BuildGraph {
	public static void main(String[] args) {
		BuildGraph b = new BuildGraph(args[0], Integer.valueOf(args[1]).intValue(), Integer.valueOf(args[2]).intValue(), Integer.valueOf(args[3]).intValue(), Integer.valueOf(args[4]).intValue());
	}
	
	BuildGraph(String fileName, int vertices, int dense, int maxCapacity, int minCapacity)
    {
